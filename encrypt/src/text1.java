...
class Password{
    ...
    public void isStringPwd(String password){//判断密码强度
...
class PasswordGenerator{//随机生成密码
    ...
    public  PasswordGenerator(){
        int length=random.nextInt(16);//随机密码长度在16之间
    ...
    public static String generatePassword(int length){
        ...
        for(int i=0;i<length;i++){
            int charSetIndex=random.nextInt(4);//随机四种情况
            switch (charSetIndex){
                case 0:
